        ...
        <TabsContent value={statusFilter} className="space-y-4">
          ...
          {isLoading ? (
            ...
            <div className="space-y-8">
              {packagesByDestination.map(
                ({ destination, packages: destPackages }) => (
                  <div key={destination} className="space-y-3">
                    <h3 className="text-lg font-semibold flex items-center gap-2">
                      ...
                      <span className="text-sm font-normal text-muted-foreground">
                        ({destPackages.length}{" "}
                        {destPackages.length === 1 ? "package" : "packages"})
                      </span>
                    </h3>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {pkg.itemCount} (
                                  {pkg.totalUnits.toLocaleString()} units)
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
                                ...
                                <span className="font-medium tabular-nums">
                                  {Number(pkg.totalVolumeM3).toLocaleString(
                                    undefined,
                                    {
                              ...
                              {pkg.status === "failed" &&
                                pkg.collateralRecoveredIsk && (
                                  <div className="flex justify-between pt-2 border-t">
                                    ...
                                    <span className="font-medium tabular-nums text-emerald-500">
                                      {formatIsk(
                                        Number(pkg.collateralRecoveredIsk),
                                      )}
                                    </span>
                                  </div>
                                )}
