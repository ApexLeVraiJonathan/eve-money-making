...
- [ ] The admin API exposes NPC versus Adam4EVE comparison data for a selected date range and station context.
- [ ] The comparison includes coverage, amount difference, order count difference, average price difference, ISK value difference, and top mismatches.
- [ ] The comparison clearly treats Adam4EVE as a reference signal rather than ground truth.
- [ ] The admin UI shows the comparison summaries and top mismatches on screen.
- [ ] The view does not add CSV, PDF, or other export behavior.
- [ ] The view does not attempt to compare self-market structure data against Adam4EVE.
- [ ] Tests cover comparison response shaping and UI/API integration boundaries.
