...
- [ ] The admin API returns scan health for NPC market gathering.
- [ ] The admin API returns scan health for self-market gathering.
- [ ] Health output includes successful run counts and missing or incomplete scan windows for the selected period.
- [ ] Health output flags unusually large day-to-day changes in market totals for review.
- [ ] Health checks do not use Adam4EVE as their authority.
- [ ] The admin UI shows scan health alongside market validation data.
- [ ] Tests cover complete, missing, and unstable scan-health scenarios.
