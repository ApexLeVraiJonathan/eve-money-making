...
export const qk = {
  ...
  arbitrage: {
    ...
    commitSummary: (cycleId: string) => ["arbitrage", "commitSummary", cycleId] as const,
  },
  ...
  cycles: {
    ...
    entries: (cycleId: string, pagination?: { limit?: number; offset?: number }) =>
    ...
    estimatedProfit: (cycleId: string) => ["cycles", "estimatedProfit", cycleId] as const,
    portfolioValue: (cycleId: string) => ["cycles", "portfolioValue", cycleId] as const,
  ...
  wallet: {
    ...
    journal: (characterId?: number) => ["wallet", "journal", characterId] as const,
  },
  ...
  gameData: {
    ...
    stations: (stationIds: number[]) => ["gameData", "stations", stationIds] as const,
  ...
  esi: {
    _root: ["esi"] as const,
    character: (characterId: number) => ["esi", "character", characterId] as const,
